...
public class PlaintextCommunicationSetup implements CommunicationSetup {
    @Override
    public ServerSecurity getServerSecurity(final String dn) {
        return new PlaintextServerSecurity();
    }

    @Override
    public ClientSecurity getClientSecurity() {
        return new PlaintextClientSecurity();
    }

    @Override
    public String toString() {
        return "PlaintextCommunicationSetup{}";
    }
}
